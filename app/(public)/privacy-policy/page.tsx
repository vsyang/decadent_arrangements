    ...
    <main className="min-h-screen bg-white text-black">
      <div className="mx-auto max-w-4xl px-6 py-16 sm:px-8 lg:px-12">
        ...
        <section className="mt-12">
          ...
          <h3 className="mt-6 text-xl font-semibold">Account Information</h3>
          ...
          <h3 className="mt-6 text-xl font-semibold">Order Information</h3>
          ...
          <ul className="mt-4 list-disc space-y-2 pl-6 leading-7">
            ...
            <li>Notes or messages related to the order</li>
        ...
        <section className="mt-12">
          ...
          <ul className="mt-4 list-disc space-y-2 pl-6 leading-7">
            ...
            <li>Allow you to place and manage orders</li>
            <li>
              Automatically fill previously provided information when
              appropriate
            </li>
            <li>Process and organize orders</li>
            ...
            <li>Improve the organization and functionality of our website</li>
            <li>
        ...
        <section className="mt-12">
          <h2 className="mb-4 text-2xl font-bold">
            3. Food Allergies and Dietary Information
          </h2>
          ...
          <p className="mt-4 leading-7">
            ...
            business operations. However, customers should not assume that
            information from a previous order will automatically be applied to
            future orders.
          </p>
        </section>
        ...
        <section className="mt-12">
          <h2 className="mb-4 text-2xl font-bold">
            5. Authentication and Login Sessions
          </h2>
        ...
        {/* 6 */}
        <section className="mt-12">
          <h2 className="mb-4 text-2xl font-bold">6. Sharing of Information</h2>
          ...
          <p className="mt-3 leading-7">
            ...
            information reasonably necessary to complete the delivery may be
            shared.
          </p>

          <h3 className="mt-6 text-xl font-semibold">Service Providers</h3>
          ...
          <p className="mt-3 leading-7">
            ...
            authentication, database infrastructure, and other technical
            services. These providers may process information on our behalf as
            necessary to provide their services.
          </p>

          <p className="mt-4 leading-7">
            We do not knowingly share customer information with third parties
        ...
        <section className="mt-12">
          <h2 className="mb-4 text-2xl font-bold">
            7. Website Hosting and Database
          </h2>
        ...
        <section className="mt-12">
          <h2 className="mb-4 text-2xl font-bold">
            8. Order-Related Communications
          </h2>
        ...
        {/* 10 */}
        <section className="mt-12">
          <h2 className="mb-4 text-2xl font-bold">10. Your Privacy Rights</h2>
          ...
          <p className="mt-4 leading-7">You may contact us to request:</p>
