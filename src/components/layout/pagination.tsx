...
function PaginationNumber({
  ...
  const className = clsx(
    'flex h-9 w-9 items-center justify-center text-sm font-medium transition-all duration-200 rounded-full border',
    {
      ...
      'bg-white border-slate-200 text-slate-600 hover:border-blue-600 hover:text-blue-600': !isActive && !isMiddle,
...
function PaginationArrow({
  ...
  const className = clsx(
    'flex h-9 w-9 items-center justify-center rounded-full border transition-all duration-200',
    {
      ...
      'bg-white border-slate-200 text-slate-600 hover:border-blue-500 hover:text-blue-500 hover:shadow-sm': !isDisabled,
    },
  );
